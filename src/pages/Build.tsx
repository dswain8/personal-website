    ...
    >
      ...
      <header className="reveal" style={{ marginBottom: '56px' }}>
        ...
        <p style={{ fontSize: '16px', color: 'var(--text-secondary)', lineHeight: 1.75 }}>
          I'm a PM learning to build. These are the projects and tools I've made;
          some live, some in progress, all real.
        </p>
      </header>
      ...
      <section>
        ...
        >
          A set of Claude workflows that run parts of my work life. Each one solves
          a specific problem and gets used every day.
        </p>
        <div
          className="reveal"
          style={{
