      ...
      <section className="home-hero">
        <div style={{ display: "flex", flexDirection: "column", gap: "26px" }}>
          ...
          <h1 className="page-title hero-enter">
            Product manager.
            <br />
            <span style={{ color: "var(--text-tertiary)" }}>Builder.</span>
          </h1>

          <p className="page-standfirst hero-enter-delay">
            I work on messy systems, make decisions quickly, and keep learning
            by building real things in public.
          </p>

          <p className="page-support hero-enter-delay">
            By day: billing, subscriptions, and quote-to-cash. Around that: AI
            workflows, PM skill-building, and a slower pursuit of cleaner living
      ...
      <section className="section-stack">
        <div className="section-heading reveal">
          ...
          <h2 className="section-title">
            The site breaks into three useful paths.
          </h2>
          <p className="section-summary">
            One shows what I&apos;ve made. One shows the system behind the work.
            One shows the lifestyle shift that is quietly shaping the rest of
            it.
          </p>
        </div>
